...
class UvePhysicalRouterConfiguration(object):
  """
  Attributes:
   - name
   - deleted
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'config_data', None, None, ), # 4
    (5, TType.STRING, 'last_get_time', None, None, ), # 5
  )

  def __init__(self, name=None, deleted=None, ip_address=None, config_data=None, last_get_time=None,):
    self.name = name
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          (length, self.config_data) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.config_data is not None:
      annotations = {}
      if oprot.writeFieldBegin('config_data', TType.STRING, 4, annotations) < 0: return -1
      if oprot.writeString(self.config_data) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.last_get_time is not None:
      annotations = {}
      if oprot.writeFieldBegin('last_get_time', TType.STRING, 5, annotations) < 0: return -1
  ...
  def log(self):
    ...
    if self.ip_address is not None:
      ...
      log_str.write('  ')
    if self.config_data is not None:
      log_str.write('config_data = ')
      log_str.write(self.config_data)
      log_str.write('  ')
    if self.last_get_time is not None:
  ...
  def __sizeof__(self):
    ...
    if self.config_data is not None:
      size += getsizeof(self.config_data)
    if self.last_get_time is not None:
...
class UvePhysicalRouterConfigurationTrace(sandesh_base.SandeshUVE):

  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'data', (UvePhysicalRouterConfiguration, UvePhysicalRouterConfiguration.thrift_spec), None, ), # 1
  )
  ...
  def update_uve(self, tdata):
    ...
    if self.data.config_data is not None:
      tdata.config_data = self.data.config_data
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.data = UvePhysicalRouterConfiguration()
...
_SANDESH_UVE_LIST = [
(UvePhysicalRouterConfigurationTrace, UvePhysicalRouterConfiguration),
]
