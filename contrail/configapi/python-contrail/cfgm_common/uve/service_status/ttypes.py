...
class UveServiceStatus(object):
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'service_name', None, None, ), # 4
    (5, TType.STRING, 'status_data', None, None, ), # 5
    (6, TType.STRING, 'operational_status', None, None, ), # 6
    (7, TType.STRING, 'last_get_time', None, None, ), # 7
  )

  def __init__(self, name=None, deleted=None, ip_address=None, service_name=None, status_data=None, operational_status=None, last_get_time=None,):
    self.name = name
    ...
    self.last_get_time = last_get_time
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          (length, self.service_name) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRING:
          (length, self.status_data) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRING:
          (length, self.operational_status) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRING:
          (length, self.last_get_time) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.service_name is not None:
      annotations = {}
      if oprot.writeFieldBegin('service_name', TType.STRING, 4, annotations) < 0: return -1
      if oprot.writeString(self.service_name) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.status_data is not None:
      annotations = {}
      if oprot.writeFieldBegin('status_data', TType.STRING, 5, annotations) < 0: return -1
      if oprot.writeString(self.status_data) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.operational_status is not None:
      annotations = {}
      if oprot.writeFieldBegin('operational_status', TType.STRING, 6, annotations) < 0: return -1
      if oprot.writeString(self.operational_status) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.last_get_time is not None:
      annotations = {}
      if oprot.writeFieldBegin('last_get_time', TType.STRING, 7, annotations) < 0: return -1
      if oprot.writeString(self.last_get_time) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
  ...
  def log(self):
    ...
    if self.ip_address is not None:
      ...
      log_str.write('  ')
    if self.service_name is not None:
      log_str.write('service_name = ')
      log_str.write(self.service_name)
      log_str.write('  ')
    if self.status_data is not None:
      log_str.write('status_data = ')
      log_str.write(self.status_data)
      log_str.write('  ')
    if self.operational_status is not None:
      log_str.write('operational_status = ')
      log_str.write(self.operational_status)
      log_str.write('  ')
    if self.last_get_time is not None:
      log_str.write('last_get_time = ')
      log_str.write(self.last_get_time)
      log_str.write('  ')
  ...
  def __sizeof__(self):
    ...
    if self.service_name is not None:
      size += getsizeof(self.service_name)
    if self.status_data is not None:
      size += getsizeof(self.status_data)
    if self.operational_status is not None:
      size += getsizeof(self.operational_status)
    if self.last_get_time is not None:
      size += getsizeof(self.last_get_time)
    return size
...
class UveServiceStatusTrace(sandesh_base.SandeshUVE):

  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'data', (UveServiceStatus, UveServiceStatus.thrift_spec), None, ), # 1
  )
  ...
  def update_uve(self, tdata):
    ...
    if self.data.service_name is not None:
      tdata.service_name = self.data.service_name
    if self.data.status_data is not None:
      tdata.status_data = self.data.status_data
    if self.data.operational_status is not None:
      tdata.operational_status = self.data.operational_status
    if self.data.last_get_time is not None:
      tdata.last_get_time = self.data.last_get_time
    return tdata
...
_SANDESH_UVE_LIST = [
(UveServiceStatusTrace, UveServiceStatus),
]
