...
class FabricTestFixtureGen(cfixture.ContrailFixture):
    ...
    """
    def __init__(self, conn_drv, fabric_name=None, parent_fixt=None, auto_prop_val=False, virtual_network_ref_infos = None, node_profile_ref_infos = None, tag_refs = None, fabric_ztp=None, fabric_os_version=None, fabric_credentials=None, fabric_enterprise_style=None, id_perms=None, perms2=None, annotations=None, display_name=None):
        '''
...
class VirtualPortGroupTestFixtureGen(cfixture.ContrailFixture):
    ...
    def setUp(self):
        ...
        if not self._parent_fixt:
            raise AmbiguousParentError("[u'fabric', 'project']")
