...
class VncApiStats(object):
  ...
  thrift_spec = (
    ...
    (11, TType.STRING, 'req_id', None, None, ), # 11
  )

  def __init__(self, operation_type=None, user=None, useragent=None, remote_ip=None, domain_name=None, project_name=None, object_type=None, response_time_in_usec=None, response_size=None, resp_code=None, req_id=None,):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          (length, self.req_id) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.req_id is not None:
      annotations = {}
      if oprot.writeFieldBegin('req_id', TType.STRING, 11, annotations) < 0: return -1
      if oprot.writeString(self.req_id) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if oprot.writeFieldStop() < 0: return -1
    if oprot.writeStructEnd() < 0: return -1
    return 0
  ...
  def log(self):
    ...
    if self.resp_code is not None:
      ...
      log_str.write('  ')
    if self.req_id is not None:
      log_str.write('req_id = ')
      log_str.write(self.req_id)
      log_str.write('  ')
    return log_str.getvalue()
...
class VncApiLatencyStats(object):
  """
  Attributes:
   - operation_type
   - application
  ...
  thrift_spec = (
    ...
    (3, TType.DOUBLE, 'response_time_in_usec', None, None, ), # 3
    (4, TType.U64, 'response_size', None, None, ), # 4
    (5, TType.STRING, 'identifier', None, None, ), # 5
  )

  def __init__(self, operation_type=None, application=None, response_time_in_usec=None, response_size=None, identifier=None,):
    self.operation_type = operation_type
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          (length, self.application) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRING:
          (length, self.identifier) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.application is not None:
      annotations = {}
      if oprot.writeFieldBegin('application', TType.STRING, 2, annotations) < 0: return -1
      if oprot.writeString(self.application) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.response_time_in_usec is not None:
      annotations = {}
      if oprot.writeFieldBegin('response_time_in_usec', TType.DOUBLE, 3, annotations) < 0: return -1
      if oprot.writeDouble(self.response_time_in_usec) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.response_size is not None:
      annotations = {}
      if oprot.writeFieldBegin('response_size', TType.U64, 4, annotations) < 0: return -1
      if oprot.writeU64(self.response_size) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.identifier is not None:
      annotations = {}
      if oprot.writeFieldBegin('identifier', TType.STRING, 5, annotations) < 0: return -1
      if oprot.writeString(self.identifier) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if oprot.writeFieldStop() < 0: return -1
    if oprot.writeStructEnd() < 0: return -1
    return 0
  ...
  def log(self):
    ...
    if self.application is not None:
      ...
      log_str.write(self.application)
      log_str.write('  ')
    if self.response_time_in_usec is not None:
      log_str.write('response_time_in_usec = ')
      log_str.write(str(self.response_time_in_usec))
    ...
    if self.response_size is not None:
      ...
      log_str.write('  ')
    if self.identifier is not None:
      log_str.write('identifier = ')
      log_str.write(self.identifier)
      log_str.write('  ')
    return log_str.getvalue()
  ...
  def __sizeof__(self):
    ...
    if self.response_size is not None:
      size += getsizeof(self.response_size)
    if self.identifier is not None:
      size += getsizeof(self.identifier)
    return size
...
class FabricJobExecution(object):
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'name', None, None, ), # 1
    (2, TType.STRING, 'execution_id', None, None, ), # 2
    (3, TType.BOOL, 'deleted', None, None, ), # 3
    (4, TType.I64, 'job_start_ts', None, None, ), # 4
    (5, TType.DOUBLE, 'percentage_completed', None, None, ), # 5
    (6, TType.STRING, 'job_status', None, None, ), # 6
  )

  def __init__(self, name=None, execution_id=None, deleted=None, job_start_ts=None, percentage_completed=None, job_status=None,):
    self.name = name
    ...
    self._table = 'ObjectJobExecutionTable'
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          (length, self.execution_id) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.I64:
          (length, self.job_start_ts) = iprot.readI64();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.DOUBLE:
          (length, self.percentage_completed) = iprot.readDouble();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRING:
          (length, self.job_status) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.execution_id is not None:
      annotations = {}
      if oprot.writeFieldBegin('execution_id', TType.STRING, 2, annotations) < 0: return -1
      if oprot.writeString(self.execution_id) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.deleted is not None:
      annotations = {}
      if oprot.writeFieldBegin('deleted', TType.BOOL, 3, annotations) < 0: return -1
      if oprot.writeBool(self.deleted) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.job_start_ts is not None:
      annotations = {}
      if oprot.writeFieldBegin('job_start_ts', TType.I64, 4, annotations) < 0: return -1
      if oprot.writeI64(self.job_start_ts) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.percentage_completed is not None:
      annotations = {}
      if oprot.writeFieldBegin('percentage_completed', TType.DOUBLE, 5, annotations) < 0: return -1
      if oprot.writeDouble(self.percentage_completed) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.job_status is not None:
      annotations = {}
      if oprot.writeFieldBegin('job_status', TType.STRING, 6, annotations) < 0: return -1
      if oprot.writeString(self.job_status) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if oprot.writeFieldStop() < 0: return -1
    if oprot.writeStructEnd() < 0: return -1
    return 0
  ...
  def log(self):
    ...
    if self.name is not None:
      ...
      log_str.write('  ')
    if self.execution_id is not None:
      log_str.write('execution_id = ')
      log_str.write(self.execution_id)
      log_str.write('  ')
    if self.deleted is not None:
      log_str.write('deleted = ')
      if self.deleted:
      ...
      log_str.write('  ')
    if self.job_start_ts is not None:
      log_str.write('job_start_ts = ')
      log_str.write(str(self.job_start_ts))
      log_str.write('  ')
    if self.percentage_completed is not None:
      log_str.write('percentage_completed = ')
      log_str.write(str(self.percentage_completed))
      log_str.write('  ')
    if self.job_status is not None:
      log_str.write('job_status = ')
      log_str.write(self.job_status)
      log_str.write('  ')
    return log_str.getvalue()
  ...
  def __sizeof__(self):
    ...
    if self.name is not None:
      size += getsizeof(self.name)
    if self.execution_id is not None:
      size += getsizeof(self.execution_id)
    if self.deleted is not None:
      size += getsizeof(self.deleted)
    if self.job_start_ts is not None:
      size += getsizeof(self.job_start_ts)
    if self.percentage_completed is not None:
      size += getsizeof(self.percentage_completed)
    if self.job_status is not None:
      size += getsizeof(self.job_status)
    return size
...
class PhysicalRouterJobExecution(object):
  """
  ...
  thrift_spec = (
    ...
    (3, TType.BOOL, 'deleted', None, None, ), # 3
    (4, TType.I64, 'job_start_ts', None, None, ), # 4
    (5, TType.STRING, 'prouter_state', None, None, ), # 5
    (6, TType.DOUBLE, 'percentage_completed', None, None, ), # 6
    (7, TType.STRING, 'job_status', None, None, ), # 7
    (8, TType.STRING, 'device_op_results', None, None, ), # 8
  )

  def __init__(self, name=None, execution_id=None, deleted=None, job_start_ts=None, prouter_state=None, percentage_completed=None, job_status=None, device_op_results=None,):
    self.name = name
    self.execution_id = execution_id
    self.deleted = deleted
    self.job_start_ts = job_start_ts
    self.prouter_state = prouter_state
    self.percentage_completed = percentage_completed
    self.job_status = job_status
    self.device_op_results = device_op_results
    self._table = 'ObjectJobExecutionTable'
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          (length, self.prouter_state) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRING:
          (length, self.device_op_results) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.job_start_ts is not None:
      ...
      if oprot.writeI64(self.job_start_ts) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.prouter_state is not None:
      annotations = {}
      if oprot.writeFieldBegin('prouter_state', TType.STRING, 5, annotations) < 0: return -1
      if oprot.writeString(self.prouter_state) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.percentage_completed is not None:
      annotations = {}
      if oprot.writeFieldBegin('percentage_completed', TType.DOUBLE, 6, annotations) < 0: return -1
      if oprot.writeDouble(self.percentage_completed) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.job_status is not None:
      annotations = {}
      if oprot.writeFieldBegin('job_status', TType.STRING, 7, annotations) < 0: return -1
      if oprot.writeString(self.job_status) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.device_op_results is not None:
      annotations = {}
      if oprot.writeFieldBegin('device_op_results', TType.STRING, 8, annotations) < 0: return -1
      if oprot.writeString(self.device_op_results) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if oprot.writeFieldStop() < 0: return -1
    if oprot.writeStructEnd() < 0: return -1
    return 0
  ...
  def log(self):
    ...
    if self.job_start_ts is not None:
      ...
      log_str.write('  ')
    if self.prouter_state is not None:
      log_str.write('prouter_state = ')
      log_str.write(self.prouter_state)
      log_str.write('  ')
    if self.percentage_completed is not None:
      log_str.write('percentage_completed = ')
      log_str.write(str(self.percentage_completed))
    ...
    if self.job_status is not None:
      ...
      log_str.write('  ')
    if self.device_op_results is not None:
      log_str.write('device_op_results = ')
      log_str.write(self.device_op_results)
      log_str.write('  ')
    return log_str.getvalue()
  ...
  def __sizeof__(self):
    ...
    if self.job_start_ts is not None:
      size += getsizeof(self.job_start_ts)
    if self.prouter_state is not None:
      size += getsizeof(self.prouter_state)
    if self.percentage_completed is not None:
      size += getsizeof(self.percentage_completed)
    if self.job_status is not None:
      size += getsizeof(self.job_status)
    if self.device_op_results is not None:
      size += getsizeof(self.device_op_results)
    return size
...
class VncApiLatencyStatsLog(sandesh_base.SandeshObject):

  thrift_spec = None

  def __init__(self, node_name=None, api_latency_stats=None, file=None, line=None, category='__default__', level=SandeshLevel.SYS_INFO, sandesh=sandesh_base.sandesh_global):
    sandesh_base.SandeshObject.__init__(self)
    self.node_name = node_name
    self.api_latency_stats = api_latency_stats
    self.file = file
    self.line = line
    self._scope = sandesh.scope()
    self._module = sandesh.module()
  ...
  def log(self, trace=False):
    ...
    if self.node_name is not None:
      log_str.write('node_name = ')
      log_str.write(self.node_name)
      log_str.write('  ')
    if self.api_latency_stats is not None:
      log_str.write('api_latency_stats = ')
      log_str.write('<<  ')
      log_str.write(self.api_latency_stats.log())
      log_str.write('>>')
      log_str.write('  ')
    if self.file is not None:
      log_str.write('file = ')
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          (length, self.node_name) = iprot.readString();
          if length < 0: return -1
          read_cnt += length
        else:
          iprot.skip(ftype)
        ...
        if ftype == TType.STRUCT:
          self.api_latency_stats = VncApiLatencyStats()
          read_cnt += self.api_latency_stats.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == -32768:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.node_name is not None:
      annotations = {}
      annotations['key'] = 'ObjectConfigNode'
      if oprot.writeFieldBegin('node_name', TType.STRING, 1, annotations) < 0: return -1
      if oprot.writeString(self.node_name) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if self.api_latency_stats is not None:
      annotations = {}
      annotations['tags'] = 'node_name,.operation_type,.application,.response_time_in_usec,.response_size,.identifier'
      if oprot.writeFieldBegin('api_latency_stats', TType.STRUCT, 2, annotations) < 0: return -1
      if self.api_latency_stats.write(oprot) < 0: return -1
      if oprot.writeFieldEnd() < 0: return -1
    if oprot.writeFieldStop() < 0: return -1
    if oprot.writeSandeshEnd() < 0: return -1
    return 0
  ...
  def compare(self, other):
    ...
    if self.node_name != other.node_name:
      return False
    if self.api_latency_stats != other.api_latency_stats:
      return False
    return True
  ...
  def __sizeof__(self):
    size = 0
    if self.node_name is not None:
      size += getsizeof(self.node_name)
    if self.api_latency_stats is not None:
      size += getsizeof(self.api_latency_stats)
    if self.file is not None:
      size += getsizeof(self.file)
    if self.line is not None:
      size += getsizeof(self.line)
...
class FabricJobUve(sandesh_base.SandeshUVE):

  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'data', (FabricJobExecution, FabricJobExecution.thrift_spec), None, ), # 1
  )
  ...
  def update_uve(self, tdata):
    ...
    if self.data.execution_id is not None:
      tdata.execution_id = self.data.execution_id
    if self.data.deleted is not None:
      tdata.deleted = self.data.deleted
    if self.data.job_start_ts is not None:
      tdata.job_start_ts = self.data.job_start_ts
    if self.data.percentage_completed is not None:
      tdata.percentage_completed = self.data.percentage_completed
    if self.data.job_status is not None:
      tdata.job_status = self.data.job_status
    return tdata
...
class PhysicalRouterJobUve(sandesh_base.SandeshUVE):

  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'data', (PhysicalRouterJobExecution, PhysicalRouterJobExecution.thrift_spec), None, ), # 1
  )
  ...
  def update_uve(self, tdata):
    ...
    if self.data.job_start_ts is not None:
      tdata.job_start_ts = self.data.job_start_ts
    if self.data.prouter_state is not None:
      tdata.prouter_state = self.data.prouter_state
    if self.data.percentage_completed is not None:
      tdata.percentage_completed = self.data.percentage_completed
    if self.data.job_status is not None:
      tdata.job_status = self.data.job_status
    if self.data.device_op_results is not None:
      tdata.device_op_results = self.data.device_op_results
    return tdata
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.data = PhysicalRouterJobExecution()
          read_cnt += self.data.read(iprot)
        else:
          iprot.skip(ftype)
      else:
...
(FabricJobUve, FabricJobExecution),
(PhysicalRouterJobUve, PhysicalRouterJobExecution),
]
